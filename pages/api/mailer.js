...
const requestAddress = process.env.REQUESTION_ADDRESS || null
...
const customerMessage = (receiver) => {
  return {
    ...
    text:
      'Thanks for requesting an appointment, You will be contacted shortly about your' +
      ' appointment.',
